...
public class ProductoController {
	...
	public ResponseEntity<?> crear(@RequestBody ProductoDTO productDTO) {
		...
		Producto product = new Producto(productDTO.getNombre(), productDTO.getNombreEng(), productDTO.getTipo(), productDTO.getPrecio(),
				productDTO.getDescripcion(), productDTO.getDescripcionEng(), productDTO.getImg(), productDTO.isEnVenta());
